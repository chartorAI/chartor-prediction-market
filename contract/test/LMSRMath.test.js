...
describe("LMSRMath", function () {
    ...
    describe("Price Calculations", function () {
        it("should calculate YES price correctly", async function () {
            ...
            const yesPrice = await testContract.calculateYesPrice(qYes, qNo, LIQUIDITY_PARAM)
        ...
        it("should calculate NO price correctly", async function () {
            ...
            const noPrice = await testContract.calculateNoPrice(qYes, qNo, LIQUIDITY_PARAM)
    ...
    describe("Edge Cases and Overflow Protection", function () {
        ...
        it("should maintain precision with reasonable numbers", async function () {
            ...
            const yesPrice = await testContract.calculateYesPrice(amount, amount, liquidity)

            const noPrice = await testContract.calculateNoPrice(amount, amount, liquidity)
